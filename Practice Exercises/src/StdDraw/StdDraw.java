...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
    ...
    /**
     * Used to draw a the union shape of a given circle and rectangle
     * 
     * @param rectangleX the x coordinate of the left of the rectangle
     * @param rectangleY the y coordinate of the top of the rectangle
    ...
    /**
     * Used to draw a the difference shape of a given circle and rectangle
	 *
     * @param rectangleX the x coordinate of the left of the rectangle
     * @param rectangleY the y coordinate of the top of the rectangle
     * @param rectangleWidth the width of the rectangle
    ...
    /**
     * Used to draw a the intersection shape of a given circle and rectangle
	 *
     * @param rectangleX the x coordinate of the left of the rectangle
     * @param rectangleY the y coordinate of the top of the rectangle
     * @param rectangleWidth the width of the rectangle
    ...
    /**
     * Used to draw a the exclusive or shape of a given circle and rectangle
	 *
     * @param rectangleX the x coordinate of the left of the rectangle
     * @param rectangleY the y coordinate of the top of the rectangle
     * @param rectangleWidth the width of the rectangle
