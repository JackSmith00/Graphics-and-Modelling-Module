...
/*                 while (!showedOnce) {
    ...
    private static Appearance createAppearance (String imageURL, boolean fill) {  
        ...
        if (imageURL != null) {
            ...
            // Custom code for Solar System Lighting
            if(imageURL.compareTo("Assets/sun.jpg") == 0) {
            	// sun texture should not be influenced, otherwise it appears dark
            	texAttr.setTextureMode(TextureAttributes.REPLACE);
            } else { // for all other Astronomical Bodies
